<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.min.css">
 	...
 	<div class="container" style="margin-top:150px;">
		...
		<canvas id="myChart2"></canvas><br><a href="admin_sales_status.do" class="btn btn-primary">매출액 보기</a>
...
<script> 
 	...
 	var myChart = new Chart(ctx, { 
 		...
 		data: { 
 			...
 			datasets: [{ label: '순이익', data: [aprice3, bprice3, 33000, 25000, 52000, 40000, 43000, 70000, 16000, 51000, 40000, 49000], 
 			backgroundColor: [ 
 				'rgba(255, 99, 132, 0.2)',
 				'rgba(54, 162, 235, 0.2)', 
 				'rgba(255, 206, 86, 0.2)', 
